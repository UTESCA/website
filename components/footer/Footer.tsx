...
const Footer:NextPage = () => {
    ...
    <div className="bg-gray-200">
        ...
        <p className="text-gray-500 text-sm text-center sm:text-left">© 2022 University of Toronto Engineering Student Consulting Association —
            <a href="https://twitter.com/knyttneve" className="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer">@Xiao215</a>
        </p>
        <span className="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-500 text-sm">Our Slogen</span>
        </div>
    </div>
    </footer>
  </div>
